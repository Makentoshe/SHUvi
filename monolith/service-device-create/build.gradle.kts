...
dependencies {
    ...
    implementation(project(dependency.module.monolith.repositoryDeviceCreate))
    implementation(project(dependency.module.monolith.repositoryCrossrefSensorDeviceCreate))
